...
# ✅ NEW: realtime WS manager + WS router
...
# ✅ NEW: init WebSocket manager (accessible via request.app.state.ws_manager)
...
# --- Error handlers (format standard) ---
